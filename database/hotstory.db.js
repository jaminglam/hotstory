...
Hotstory.prototype.getLatestHotstories = function(limit, callback) {
    // let start = new Date();
    ...
    let escapedLimit = con.escape(limit-1);
    var _sql = 'select * from hotstory where hotstory_id >= ((select max(hotstory_id) from hotstory) - ' + escapedLimit + ')';
